...
/*	//单机
	...
	public void tese3(){
		...
		nodeSet.add(new HostAndPort("115.28.16.234",7002));
		nodeSet.add(new HostAndPort("115.28.16.234",7003));
		nodeSet.add(new HostAndPort("115.28.16.234",7004));
		nodeSet.add(new HostAndPort("115.28.16.234",7005));
		nodeSet.add(new HostAndPort("115.28.16.234",7006));
